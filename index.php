...
$faqs = [
    ...
    [
        ...
        'risposta' => explode(';', "Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.
...
<body>
    ...
    <header>
        <div class="navbar">
            <div class="nav-top">
                <div class="left-side">
                    <div class="logo">
                        <img src="https://www.ra.camcom.gov.it/eurosportello/allegati-giuseppe/loghi/logo-google/image"
                            alt="">
                    </div>
    ...
    <main id="site_main">
        <div class="container">
            ...
            <?php foreach ($faq['risposta'] as $risposta) { ?>
